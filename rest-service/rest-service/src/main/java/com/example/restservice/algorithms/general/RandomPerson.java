...
public class RandomPerson {
    String[] name = new String[]{"Boeru Cezara", "Bogătoiu Paula", "Brandabur Flavius", "Camară Diana", "Caplat Miruna", "Ciobanu Răzvan", "Cojocariu Alexandra", "Constandiș Andreea", "Copăcel Ștefania",
            "Crețu Tudor", "Darie Teodora", "Dobrin Cătălina", "Iftimie Vlad", "Martiș Robert", "Munteanu Ștefan", "Nichifor Elena", "Radu Daniela",
            "Șandru Andrada", "Șchiopu Ana Maria", "Șerban Iustinian", "Tănasă Ștefania", "Triandafil Maria", "Tudoreanu Ema", "Vartolomei Emilia"};
    ...
    private boolean verify(String result) {
        ...
        if(alreadyPicked.size() == 23) alreadyPicked.clear();
